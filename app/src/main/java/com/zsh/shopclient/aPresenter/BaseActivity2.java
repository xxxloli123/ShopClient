 ...
 */
public class BaseActivity2 extends Activity implements Callback {
...
//                    R.anim.in_from_right, R.anim.out_to_left);
    ...
    public void onFailure(final Call call, final IOException e) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(BaseActivity2.this, "网络错误", Toast.LENGTH_SHORT).show();
                onFail(call, e);
            }
        });
    }
            ...
            public void run() {
                try {
                    ...
                    if (json.getInt("statusCode") == 200)
                        ...
                        Toast.makeText(BaseActivity2.this, json.getString("message"), Toast.LENGTH_SHORT).show();
                        onFail(call, null);
                    }
                } catch (JSONException e) {
                    Toast.makeText(BaseActivity2.this, "解析数据失败", Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                }
            }
        });
