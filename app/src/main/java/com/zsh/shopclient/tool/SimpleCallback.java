...
public abstract class SimpleCallback implements Callback {
    ...
    public SimpleCallback(Context context,boolean isMessage) {
        this(context, null);
                ...
                switch (msg.what) {
                    case 0:
                        ...
                        if (json.getJSONObject("result").getInt("statusCode") == 200){
                            ...
                            if (isMessage)Toast.makeText(context, json.getJSONObject("result").getString("message"), Toast.LENGTH_SHORT).show();
                        }
                        else {
                            onFail(json);
                        }
